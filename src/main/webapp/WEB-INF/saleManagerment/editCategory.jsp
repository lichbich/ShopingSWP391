                ...
                <div class="tile-body">
                    <form action="${pageContext.request.contextPath}/editCategory" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="description" name="description" value="${category.description}" class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href="${pageContext.request.contextPath}/listCategory" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
