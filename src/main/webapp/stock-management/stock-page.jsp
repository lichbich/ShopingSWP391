...
<header class="app-header">
    ...
    <ul class="app-nav">
        ...
        <!-- User Menu-->
        <li><a class="app-nav__item" href="<c:url value='/index.html'/>"><i class='bx bx-log-out bx-rotate-180'></i> </a>
...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item " href="../color-management/color-page.jsp"><i class='app-menu__icon bx bx-task'></i><span
        ...
        <li><a class="app-menu__item active" href="table-data-money.html"><i class='app-menu__icon bx bx-dollar'></i><span
                class="app-menu__label">Stock Management</span></a></li>
...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item active"><a href="#"><b>Stock Management</b></a></li>
        </ul>
        <div id="clock"></div>
    </div>
    <div class="row">
                ...
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="form-add-tien-luong.html" title="Add"><i class="fas fa-plus"></i>
                                Add new</a>
                        </div>
                        <div class="col-sm-2">
                            <a class="btn btn-delete btn-sm nhap-tu-file" type="button" title="Import" onclick="myFunction(this)"><i
                                    class="fas fa-file-upload"></i> Import</a>
                        </div>

                        <div class="col-sm-2">
                            <a class="btn btn-excel btn-sm" href="" title="In"><i class="fas fa-file-excel"></i> Export</a>
                        </div>
                    </div>
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <c:forEach var="stock" items="${stock}">
                            <c:if test="${stock != null && stock.size > 0}">
                                <tr>
                                    <td></td>
                                    <td>${stock.productCode}</td>
                                    <td>${stock.productName}</td>
                                    <td>
                                        <c:forEach var="color" items="${stock.colorDtos}">
                                            <div>${color.colorCode}</div>
                                        </c:forEach>
                                    </td>
                                    <td>${stock.price}</td>
                                    <td>
                                        <c:forEach var="size" items="${stock.sizeDtos}">
                                            <div>${size.size}</div>
                                        </c:forEach>
                                    </td>
                                    <td>${stock.quantity}</td>
                                    <td><span class="badge bg-${stock.isActive ? 'success' : 'danger'}">${stock.isActive ? 'Activation' : 'Deactivation'}</span></td>
                                    <td>
